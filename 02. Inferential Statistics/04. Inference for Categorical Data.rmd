...
inference(y = response, data = br12, statistic = "proportion", type = "ci", 
          method = "theoretical", success = "atheist")

ar12 <- atheism %>%
  filter(nationality == "Argentina" , atheism$year == "2012")

inference(y = response, data = ar12, statistic = "proportion", type = "ci", 
          method = "theoretical", success = "atheist")
```
...
inference(y = response, x = as.factor(year), data = Spain, statistic = "proportion", type = "ht", 
          null = 0, success = "atheist", alternative = "twosided", method = "theoretical")
```
...
inference(y = response, x = as.factor(year), data = US, statistic = "proportion", type = "ht", 
          null = 0, success = "atheist", alternative = "twosided", method = "theoretical")
```
